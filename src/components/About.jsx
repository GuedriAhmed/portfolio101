...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    <div className="inline-block relative group">
      <h2 
        className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-800 to-cyan-400" 
        data-aos="zoom-in-up"
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            <h2 
              ...
              data-aos-duration="1000"
            >
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-800 to-cyan-400">
                Hello, I'm
              </span>
              <span 
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
           I studied at ISTIC Cedria and ESPRIT, where I built a strong foundation in computer science and engineering. Along the way, I discovered my passion for crafting solutions that combine functionality with elegance whether it’s with Angular, Spring Boot, ReactJS, Node.js, or Express. etc. </p>
          ...
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              ...
              <button 
                data-aos="fade-up"
                data-aos-duration="1000"
                className="w-full lg:w-auto sm:px-6 py-2 sm:py-3 rounded-lg border border-cyan-400/50 text-cyan-400 font-medium transition-all duration-300 hover:scale-105 flex items-center justify-center lg:justify-start gap-2 hover:bg-[#a855f7]/10 "
              >
